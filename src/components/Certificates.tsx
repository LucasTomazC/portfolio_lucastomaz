        ...
        >
          {CERTIFICATES_DATA.map((cert) => (
            <motion.div
              ...
              className="bg-[#0d0d0d] border border-white/5 p-6 flex flex-col justify-between relative group hover:border-[#5DADE2]/30 transition-all duration-300 shadow-[0_0_30px_rgba(0,0,0,0.3)] hover:shadow-[0_0_40px_rgba(93,173,226,0.05)]"
              ...
              <div>
                <div className="flex flex-wrap gap-1.5 mb-6 border-t border-white/5 pt-4">
                  {cert.techs.slice(0, 3).map((tech) => (
                    <span
                      key={tech}
                      className="text-[9px] font-mono px-2 py-0.5 border border-white/5 bg-white/5 text-white/50"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <a
                  ...
                  className="w-full py-2.5 border border-white/5 hover:border-white/20 text-[10px] font-display font-semibold tracking-wider text-white/70 hover:text-white uppercase flex items-center justify-center gap-1.5 hover:bg-white/5 transition-all duration-300"
                  style={{ borderRadius: "0px" }} // Sharp geometry choice
                >
